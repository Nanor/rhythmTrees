...
spec = do
    ...
    describe "fromEuterpea" $ do
        ...
        it "should enforce splitting into bars" $
            fromEuterpea (line [note (3 % 4) ((C, 3), []), rest qn, note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), [])]) `shouldBe`
                Branch [Single RT.Note,Branch [Single Tie,Single RT.Rest],Branch [Single RT.Note,Single RT.Note],Branch [Single RT.Note,Single RT.Note],Branch [Single RT.Note,Single RT.Note],Branch [Single RT.Note,Single RT.Note]]
        it "should enforce splitting into bars with tied bars" $
            fromEuterpea (line [note (3 % 4) ((C, 3), []), note hn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), [])]) `shouldBe`
                Branch [Single RT.Note,Branch [Single Tie,Single RT.Note],Branch [Single RT.Tie,Single RT.Note],Branch [Single RT.Note,Single RT.Note],Branch [Single RT.Note,Single RT.Note],Branch [Single RT.Note,Single RT.Note]]
        it "should pad the end with rests to split into bars" $
            fromEuterpea (line [note (3 % 4) ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), []), note qn ((C, 3), [])]) `shouldBe`
                Branch [Single RT.Note, Branch [Single Tie, Single RT.Note], Branch [Single RT.Note, Single RT.Note], Single RT.Rest]
